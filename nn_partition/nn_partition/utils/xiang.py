import torch
import numpy as np
from nn_partition.models.models import model_xiang_2017, model_xiang_2020_robot_arm, model_gh1
...
use_julia = False
if use_julia:
    from nn_partition.jul import julia_output_range, torch2julianet, query_model
