...
if __name__ == '__main__':
    ...
    torch_model = load_controller(system='GroundRobotSI', model_name='complex_potential_field')
    ...
    lower_A, upper_A, lower_sum_b, upper_sum_b = torch_model_.full_backward_range(
        norm=np.inf,
