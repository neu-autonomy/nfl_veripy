...
class NoPartitioner(Partitioner):
    ...
    def get_output_range(self, input_range, propagator):
        ...
        propagator_computation_time = t_end - t_start
        num_propagator_calls = 1
        info = self.compile_info(output_range_sim, [(input_range, output_range)], [], num_propagator_calls, t_end, t_start, propagator_computation_time, iteration)
...
class SimGuidedPartitioner(Partitioner):
    def __init__(self, num_simulations=1000, termination_condition_type="input_cell_size", termination_condition_value=0.1, interior_condition="linf", make_animation=False, show_animation=False, show_input=True, show_output=True, adaptive_flag=False):
        Partitioner.__init__(self)
        self.num_simulations = num_simulations
        self.termination_condition_type = termination_condition_type
        self.termination_condition_value = termination_condition_value
    ...
    def expand_partition(self,propagator,sampled_inputs,sampled_outputs,output_range_sim, input_range, num_propagator_calls, propagator_computation_time):
       ...
       # tolerance_eps = 0.05
        ...
        center_NN=kdt.query(sampled_output_center.reshape(1,-1), k=1, return_distance=False)
...
class GreedySimGuidedPartitioner(SimGuidedPartitioner):
    def __init__(self, num_simulations=1000, interior_condition="linf", make_animation=False, show_animation=False, termination_condition_type="interior_cell_size", termination_condition_value=0.02, show_input=True, show_output=True, adaptive_flag=False):
        SimGuidedPartitioner.__init__(self, num_simulations=num_simulations, interior_condition=interior_condition, make_animation=make_animation, show_animation=show_animation,
            termination_condition_type=termination_condition_type, termination_condition_value=termination_condition_value, show_input=show_input, show_output=show_output, adaptive_flag = adaptive_flag )
...
class AdaptiveSimGuidedPartitioner(GreedySimGuidedPartitioner):
    def __init__(self, num_simulations=1000, interior_condition="linf", make_animation=False, show_animation=False, termination_condition_type="interior_cell_size", termination_condition_value=0.02, show_input=True, show_output=True):
        GreedySimGuidedPartitioner.__init__(self, num_simulations=num_simulations, interior_condition=interior_condition, make_animation=make_animation, show_animation=show_animation,
            termination_condition_type=termination_condition_type, termination_condition_value=termination_condition_value, show_input=show_input, show_output=show_output, adaptive_flag=True)
