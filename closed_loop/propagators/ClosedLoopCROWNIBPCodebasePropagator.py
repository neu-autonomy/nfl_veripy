    ...
    def get_one_step_reachable_set(self, input_constraint, output_constraint):
        ...
        if isinstance(input_constraint, constraints.PolytopeInputConstraint):
            ...
            try:
                ...
                vertices = np.stack(pypoman.compute_polytope_vertices(A_inputs, b_inputs+1e-6))
        ...
        lower_A, upper_A, lower_sum_b, upper_sum_b = self.network(method_opt=self.method_opt,
                                    norm=norm,
                                    x_U=nn_input_max, x_L=nn_input_min,
        ...
        for i in range(num_facets):
            ...
            A_out_xt1_max, A_out_xt1_min = self.network.compute_bound_from_matrices(lower_A, lower_sum_b, upper_A, upper_sum_b, 
                prev_state_max, prev_state_min, norm,
